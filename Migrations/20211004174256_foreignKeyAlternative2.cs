...
{
    public partial class foreignKeyAlternative2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "CsharpVariable",
                newName: "IX_CsharpVariable_AstNodeId");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CsharpMethod_CsharpAstNodes_AstNodeId",
                        column: x => x.AstNodeId,
                        principalTable: "CsharpAstNodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CsharpEnumMember_CsharpAstNodes_AstNodeId",
                        column: x => x.AstNodeId,
                        principalTable: "CsharpAstNodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CsharpEnumMember_AstNodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CsharpMethod_AstNodeId",
                table: "CsharpMethod",
                column: "AstNodeId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CsharpVariable_CsharpAstNodes_AstNodeId",
                table: "CsharpVariable",
                column: "AstNodeId",
                principalTable: "CsharpAstNodes",
                principalColumn: "Id",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                name: "IX_CsharpVariable_AstNodeId",
                table: "CsharpEntity",
                newName: "IX_CsharpEntity_AstNodeId");
